  ...
  const EmptyState = () => {
    return (
      ...
      >
        ...
        <div
          className="tj-text-md text-secondary"
          data-cy="empty-ds-page-text"
        >
  ...
  return (
    <>
      <div style={{ overflow: 'hidden' }}>
        <div
          className="w-100 datasource-inner-sidebar-wrap"
          data-cy="datasource-Label"
        >
          {isLoading ? (
            <Skeleton
              containerClassName="datasource-loader"
              count={3}
              height={30}
            />
          ) : (
            <>
              <div
                className="d-flex justify-content-between datasources-search"
                style={{ marginBottom: '8px' }}
              >
                {!showInput ? (
                  <>
                    <div
                      className="datasources-info tj-text-xsm"
                      data-cy="added-ds-label"
                    >
                      Data Sources Added{' '}
