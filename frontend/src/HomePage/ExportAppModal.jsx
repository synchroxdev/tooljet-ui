        ...
        <>
          <BootstrapModal.Body>
            <div>
              ...
              >
                <span
                  data-cy="current-version-label"
                  className="current-version-label"
                >
                  Current Version
                </span>
                <InputRadioField
              ...
              {versions.length >= 2 ? (
                ...
                >
                  <span
                    data-cy="other-version-label"
                    className="other-version-label"
                  >
                    Other Versions
                  </span>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className="export-creation-date tj-text-sm"
